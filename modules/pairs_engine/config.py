...
PAIRS_CONFIG = [
    ...
    # ═══════════════════════════════════════════════════════════════
    # AUTO-COINT 21-jul-2026 — pares NOVOS achados por cointegracao (6m diario)
    # ADF<=-2.9, corr>=0.6. Origem: varredura estatistica (nao lista fixa).
    # ═══════════════════════════════════════════════════════════════
    {'id': 'EQTL3-CPFE3', 'name': 'EQTL3/CPFE3 (coint 6m)', 'leg_a': 'EQTL3', 'leg_b': 'CPFE3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 0.473, 'half_life_days': 3.4, 'adf_tstat': -4.39,
     'return_corr': 0.67, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'ITUB4-BBDC3', 'name': 'ITUB4/BBDC3 (coint 6m)', 'leg_a': 'ITUB4', 'leg_b': 'BBDC3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 2.218, 'half_life_days': 6.2, 'adf_tstat': -2.96,
     'return_corr': 0.84, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'BPAC11-CCRO3', 'name': 'BPAC11/CCRO3 (coint 6m)', 'leg_a': 'BPAC11', 'leg_b': 'CCRO3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 3.103, 'half_life_days': 3.6, 'adf_tstat': -3.57,
     'return_corr': 0.73, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'MULT3-CCRO3', 'name': 'MULT3/CCRO3 (coint 6m)', 'leg_a': 'MULT3', 'leg_b': 'CCRO3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 1.742, 'half_life_days': 4.8, 'adf_tstat': -3.46,
     'return_corr': 0.79, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'TAEE11-CPFE3', 'name': 'TAEE11/CPFE3 (coint 6m)', 'leg_a': 'TAEE11', 'leg_b': 'CPFE3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 0.505, 'half_life_days': 3.7, 'adf_tstat': -4.06,
     'return_corr': 0.63, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'ITSA4-TAEE11', 'name': 'ITSA4/TAEE11 (coint 6m)', 'leg_a': 'ITSA4', 'leg_b': 'TAEE11',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 0.282, 'half_life_days': 4.4, 'adf_tstat': -3.4,
     'return_corr': 0.73, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'RDOR3-CCRO3', 'name': 'RDOR3/CCRO3 (coint 6m)', 'leg_a': 'RDOR3', 'leg_b': 'CCRO3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 2.816, 'half_life_days': 4.4, 'adf_tstat': -3.37,
     'return_corr': 0.61, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'ALOS3-CCRO3', 'name': 'ALOS3/CCRO3 (coint 6m)', 'leg_a': 'ALOS3', 'leg_b': 'CCRO3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 1.649, 'half_life_days': 5.2, 'adf_tstat': -3.29,
     'return_corr': 0.79, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'RENT3-RDOR3', 'name': 'RENT3/RDOR3 (coint 6m)', 'leg_a': 'RENT3', 'leg_b': 'RDOR3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 1.035, 'half_life_days': 5.8, 'adf_tstat': -3.13,
     'return_corr': 0.65, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'EQTL3-CMIG4', 'name': 'EQTL3/CMIG4 (coint 6m)', 'leg_a': 'EQTL3', 'leg_b': 'CMIG4',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 2.035, 'half_life_days': 4.9, 'adf_tstat': -3.01,
     'return_corr': 0.68, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'PETR3-PRIO3', 'name': 'PETR3/PRIO3 (coint 6m)', 'leg_a': 'PETR3', 'leg_b': 'PRIO3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 0.745, 'half_life_days': 4.9, 'adf_tstat': -3.0,
     'return_corr': 0.66, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'ITSA4-CCRO3', 'name': 'ITSA4/CCRO3 (coint 6m)', 'leg_a': 'ITSA4', 'leg_b': 'CCRO3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 0.493, 'half_life_days': 6.1, 'adf_tstat': -2.99,
     'return_corr': 0.76, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'MULT3-CPFE3', 'name': 'MULT3/CPFE3 (coint 6m)', 'leg_a': 'MULT3', 'leg_b': 'CPFE3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 0.462, 'half_life_days': 6.8, 'adf_tstat': -2.99,
     'return_corr': 0.61, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'RENT3-EZTC3', 'name': 'RENT3/EZTC3 (coint 6m)', 'leg_a': 'RENT3', 'leg_b': 'EZTC3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 3.235, 'half_life_days': 2.9, 'adf_tstat': -4.11,
     'return_corr': 0.63, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
    {'id': 'LREN3-CYRE3', 'name': 'LREN3/CYRE3 (coint 6m)', 'leg_a': 'LREN3', 'leg_b': 'CYRE3',
     'pair_type': 'CROSS_SECTOR', 'tier': 'B', 'z_entry': 2.0, 'z_exit': 0.4, 'z_stop': 3.5,
     'beta_a_to_b': 0.119, 'half_life_days': 3.9, 'adf_tstat': -3.24,
     'return_corr': 0.6, 'price_corr': 0.0, 'expected_bps': 0, 'score': 150.0,
     'enabled': True, 'liquidity_tier': 'B', 'origin': 'AUTO-COINT-21jul'},
